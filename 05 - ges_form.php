...
<body> 
	...
	<p>Gestion del formulario.</p>
	<br/>
	<?php
		$nombre=$_POST['email'];
		$contrasena=$_POST['contrasena'];

		if ($nombre=="Javier" && $contrasena=="javier"){
			header('Location: 05 - javier.php');
		}else if($nombre=="Vero" && $contrasena=="vero"){
			header('Location: 05 - vero.php');
		}else if($nombre=="Angela" && $contrasena=="angela"){
			header('Location: 05 - angela.php');
		}else if($nombre=="Rosa" && $contrasena=="rosa"){
			header('Location: 05 - rosa.php');
		}else{
			header('Location: 05 - invitado.php');
		}
	?>
